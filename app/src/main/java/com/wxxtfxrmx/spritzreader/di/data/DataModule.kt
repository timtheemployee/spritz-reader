...
import com.wxxtfxrmx.spritzreader.data.repository.ConfigRepositoryImpl
...
interface DataModule {
	...
	companion object {
		...
		@Provides
		@Singleton
		fun provideConfigDataSource(preferences: Preferences): ConfigDataSource =
			ConfigDataSourceImpl(preferences)
	}
